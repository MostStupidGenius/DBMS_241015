...
STADIUM_NAME  VARCHAR2(140) NOT NULL,
HOMETEAM_ID   CHAR(3),
SEAT_COUNT    NUMBER,
...
REGION_NAME VARCHAR2(18) NOT NULL,
TEAM_NAME   VARCHAR2(140) NOT NULL,
E_TEAM_NAME VARCHAR2(150),
ORIG_YYYY   CHAR(4),
STADIUM_ID  CHAR(3) NOT NULL,
ZIP_CODE1   CHAR(3),
ZIP_CODE2   CHAR(3),
...
TEAM_ID       CHAR(3) NOT NULL,
E_PLAYER_NAME VARCHAR2(140),
NICKNAME      VARCHAR2(130),
JOIN_YYYY     CHAR(4),
POSITION      VARCHAR2(110),
BACK_NO       NUMBER(2),
NATION        VARCHAR2(120),
BIRTH_DATE    DATE,
SOLAR         CHAR(1),
